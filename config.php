...
if (!defined('SUPABASE_PROJECT_REF')) {
    define('SUPABASE_PROJECT_REF', 'ebwnjglojcsloxqirjwo');
}
if (!defined('SUPABASE_ANON_KEY')) {
    define('SUPABASE_ANON_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVid25qZ2xvamNzbG94cWlyandvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYxOTY3NjUsImV4cCI6MjA5MTc3Mjc2NX0.wTUmHrZo8J7-SCGNs2CJqgxWidOLR4-t1OIClHUEB1s');
}
if (!defined('SUPABASE_SERVICE_ROLE_KEY')) {
    define('SUPABASE_SERVICE_ROLE_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NjE5Njc2NSwiZXhwIjoyMDkxNzcyNzY1fQ.K7h3tVasjRBZ6pBZqy7BQY0evwSj-ly9h6uNTamWFug');
}
